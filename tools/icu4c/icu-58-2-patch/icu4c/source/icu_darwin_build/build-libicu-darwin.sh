...
var_darwin_tag="darwin$(clang --version | awk '/version/ {print $4}' | cut -d. -f1)"
var_build_dir_title="icu_${var_darwin_tag}_build"
...
cp -f ${var_build_sh_files_dir}/icu4c_build_darwin_tpl.sh ${var_build_dir_macosx}/
cp -f ${var_build_sh_files_dir}/icu4c_build_darwin.sh ${var_build_dir_macosx}/

cp -f ${var_build_sh_files_dir}/icu4c_build_darwin_tpl.sh ${var_build_dir_iphoneos}/
cp -f ${var_build_sh_files_dir}/icu4c_build_darwin.sh ${var_build_dir_iphoneos}/

cp -f ${var_build_sh_files_dir}/icu4c_build_darwin_tpl.sh ${var_build_dir_iphonesimulator}/
cp -f ${var_build_sh_files_dir}/icu4c_build_darwin.sh ${var_build_dir_iphonesimulator}/

# macosx
cd ${var_build_dir_macosx}
sh icu4c_build_darwin.sh \
    ${var_sdk_name_macosx} \
    ${var_sdk_ver_min_mac} \
