#
#	lua546_static_ts definitions.
#

LOCAL_PATH := $(call my-dir)

USRDEF_LOCAL_PROJECT_NAME := lua546_static_ts

l_path := $(LOCAL_PATH)

# output module name
ifeq ($(NDK_DEBUG), 1)
	l_module := liblua504_ts$(USRDEF_APP_COMPILER_VERSION_TAG)-s-d
else
	l_module := liblua504_ts$(USRDEF_APP_COMPILER_VERSION_TAG)-s
endif
