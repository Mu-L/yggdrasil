...
mingw32-make.exe -j12 -f Makefile_yggr NODOTABIVER=jit501-mgw15-d CCDEBUG=-g
...
mingw32-make.exe -j12 -f Makefile_yggr NODOTABIVER=jit501-mgw15-s-d CCDEBUG=-g BUILDMODE=static
mv -f libluajit501-mgw15-s-d.a out_lua_jit210/lib64/libluajit501-mgw15-s-d.a

mingw32-make.exe -f Makefile_yggr NODOTABIVER=jit501-mgw15-s-d clean
rm *.exe
rm *.o
rm host/*.o
rm host/*.exe

mingw32-make.exe -j12 -f Makefile_yggr NODOTABIVER=jit501-mgw15 CFLAGS=-O3 LDFLAGS=-s
...
mingw32-make.exe -j12 -f Makefile_yggr NODOTABIVER=jit501-mgw15-s CFLAGS=-O3 LDFLAGS=-s BUILDMODE=static
mv -f libluajit501-mgw15-s.a out_lua_jit210/lib64/libluajit501-mgw15-s.a
...
mingw32-make.exe -j12 -f Makefile_yggr NODOTABIVER=jit501-mgw15-s-d CCDEBUG=-g CC="$(DEFAULT_CC) -m32" BUILDMODE=static
mv -f libluajit501-mgw15-s-d.a out_lua_jit210/lib/libluajit501-mgw15-s-d.a
...
mingw32-make.exe -j12 -f Makefile_yggr NODOTABIVER=jit501-mgw15-s CFLAGS=-O3 CC="$(DEFAULT_CC) -m32" LDFLAGS=-s BUILDMODE=static
mv -f libluajit501-mgw15-s.a out_lua_jit210/lib/libluajit501-mgw15-s.a

cp -f luajit.exe out_lua_jit210/exe32/mgw15/luac.exe

mingw32-make.exe -f Makefile_yggr NODOTABIVER=jit501-mgw15-s clean
rm *.o
rm host/*.o
rm host/*.exe
