...
#libblowfish
rm -f libblowfish
ln -s blowfish-macosx libblowfish
...
#libzlib
rm -f libzlib
ln -s libzlib-1.3-macosx libzlib
...
#libopenssl
rm -f libopenssl
ln -s openssl_3.4.0-macosx libopenssl
...
ln -s intel_bid-macosx IntelRDFPMathLib
...
#lua_514
#rm -f lua
#ln -s lua5_14-macosx lua

rm -f lua_514
ln -s lua5_14-macosx lua_514
...
#lua_521
#rm -f lua
#ln -s lua5_21-macosx lua

rm -f lua_521
ln -s lua5_21-macosx lua_521
...
#rm -f lua
#ln -s lua5_34-macosx lua

rm -f lua_534
ln -s lua5_34-macosx lua_534
...
#lua5_46
rm -f lua
ln -s lua5_46-macosx lua

rm -f lua_546
ln -s lua5_46-macosx lua_546
...
#lua_jit21
#rm -f lua
#ln -s luajit21-macosx lua

rm -f lua_jit21
ln -s luajit21-macosx lua_jit21
...
#luabind_501
#rm -f luabind
#ln -s luabind_501-macosx luabind

rm -f luabind_501
ln -s luabind_501-macosx luabind_501
...
#luabind_502
#rm -f luabind
#ln -s luabind_502-macosx luabind

rm -f luabind_502
ln -s luabind_502-macosx luabind_502
...
#luabind_503
#rm -f luabind
#ln -s luabind_503-macosx luabind

rm -f luabind_503
ln -s luabind_503-macosx luabind_503
...
#luabind_504
rm -f luabind
ln -s luabind_504-macosx luabind

rm -f luabind_504
ln -s luabind_504-macosx luabind_504
...
#luabind_jit21
#rm -f luabind
#ln -s luabind_jit21-macosx luabind

rm -f luabind_jit21
ln -s luabind_jit21-macosx luabind_jit21
...
ln -s mongodb_c_driver-macosx mongodb_c_driver
