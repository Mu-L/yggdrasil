...
#var_prefix_dir=/Users/${USER}/third_part/${var_projname}-${var_sdk_name}
var_prefix_dir=/Users/${USER}/third_part/${var_projname}-${var_projver}
...
ln -s "${var_local_dir}/build-cyrus-sasl2-darwin_tpl.sh" "${var_build_dir}/build-cyrus-sasl2-darwin_tpl.sh"

cd "${var_build_dir}"

sh build-cyrus-sasl2-darwin_tpl.sh \
    ${var_prefix_dir} \
    ${var_host} \
    ${var_sdk_name} \
    ${var_sdk_ver_min}
...
var_prefix_dir=/Users/${USER}/third_part_iphoneos/${var_projname}-${var_projver}
...
var_sdk_ver_min=15.6
#var_prefix_dir=${var_perfix_root_dir}/${var_projname}-${var_sdk_name}
var_prefix_dir=/Users/${USER}/third_part_iphonesimulator/${var_projname}-${var_projver}
var_host=x86_64-apple-darwin
