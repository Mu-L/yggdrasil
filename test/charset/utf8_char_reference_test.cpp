...
void test_utf8_char_reference(void)
{
	...
	// operator=
	{
		...
		ch_ref = yggr::charset::make_string_charset_helper(L'Âð');
		yggr_test_assert(ch_ref == L"Âð");
		yggr_test_assert(ch == L"Âð");
	}
	...
	// assign
	{
		// assign(char)
		{
			...
			ch_ref.assign(yggr::charset::make_string_charset_helper(L'Âð'));
...

		{
			...
			ch_ref.assign(yggr::charset::make_string_charset_helper(L"Âð"), 1);
...

		{
			...
			ch_ref.assign(yggr::charset::make_string_charset_helper(std::wstring(L"Âð")));
...

		{
			...
			ch_ref.assign(yggr::charset::make_string_charset_helper(boost::container::wstring(L"Âð")));
...

		{
			...
			ch_ref.assign(yggr::charset::make_string_charset_helper(char_type(L"Âð")));
